...
// first approach to lunch the browser ann navigate to the Url
    public  void openBrowser(String url) throws IOException {
        setUp(false,"browserStack","windows","10","chrome","91",url);
    }
   ...
   // @AfterMethod(alwaysRun = true) //this need to be comment because @after method annotation is coming from testNG
    //and we are using junit
    public void cleanUp() {
        //driver.close();
        driver.quit();
    }
